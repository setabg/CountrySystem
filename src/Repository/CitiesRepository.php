...
class CitiesRepository extends ServiceEntityRepository
{
    ...
    public function findCityByKeyword(string $search = null):array

    {
        $queryBuilder = $this->createQueryBuilder('cities');
        if ($search) {
            $queryBuilder->andWhere('cities.cityname LIKE :searchTerm')
